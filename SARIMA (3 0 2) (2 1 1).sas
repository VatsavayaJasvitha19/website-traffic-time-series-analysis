...
proc arima data=Work.preProcessedData plots
     (only)=(series(corr) residual(corr normal) forecast(forecast 
		forecastonly) ) out=work.out;
	identify var='Page.Loads'n(52) outcov=work.outcov;
	estimate p=(1 2 3) (52 104) q=(1 2) (52) method=ML outest=work.outest 
